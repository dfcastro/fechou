...
*/
    ...
    |--------------------------------------------------------------------------
    |
    | Uma logo pode continuar armazenada após downgrade.
    | O que decide se ela pode ser exibida é a feature
    | CUSTOM_BRANDING do plano atual.
    |
    */
...
*/
    ...
    public function businessWhatsappUrl(): ?string
    {
        ...
        $message =
            "Olá! Estou entrando em contato sobre a proposta "
            . "#{$number} — {$this->quote->title}, "
            . "no valor de R$ {$total}.";
...
*/
    ...
    public function reject(): void
    {
        $validated = $this->validate(
            [
                'rejectReason' => [
                    'nullable',
                    'string',
                    'in:price,deadline,scope,postpone,other',
                ],
                'rejectComment' => [
                    'nullable',
                    'string',
        ...
        $reason = $validated['rejectReason'] ?: null;

        $reasonLabel = match ($reason) {
            'price' => 'Preço',
            'deadline' => 'Prazo',
            'scope' => 'Escopo',
            'postpone' => 'Vou avaliar depois',
            'other' => 'Outro',
            default => null,
        };

        $comment = trim(
            (string) ($validated['rejectComment'] ?? '')
        );

        DB::transaction(function () use ($reason, $reasonLabel, $comment) {
            $quote = Quote::query()
                ->where('public_token', $this->token)
                ->lockForUpdate()
                ->firstOrFail();
        ...
        @if ($this->quote->status === 'accepted')
                ...
                'd/m/Y \à\s H:i'
                        ...
                        @if ($this->businessWhatsappUrl)
                            <a href="{{ $this->businessWhatsappUrl }}" target="_blank" rel="noopener noreferrer" class="
    ...
    : 'itens'
            ...
            <div class="divide-y divide-zinc-100 dark:divide-zinc-800">
                ...
                @foreach ($this->quote->items as $item)
                                ...
                                <div wire:key="public-item-{{ $item->id }}" class="px-5 py-4 sm:px-6">
    ...
    '.'
        ...
        @if (in_array($this->quote->status, ['sent', 'viewed'], true))
                ...
                <section class="
                    ...
                    <div x-show="decision === null" class="p-5 sm:p-7">
                        ...
                        <div class="
                            ...
                            <button type="button" x-on:click="decision = 'reject'" class="
                                                                                                inline-flex
                                                                                                items-center
                                                                                                justify-center
                            ...
                            <button type="button" x-on:click="decision = 'accept'" class="
                                                                                                inline-flex
                                                                                                items-center
                                                                                                justify-center
                                                                                                gap-2
                    ...
                    <div x-cloak x-show="decision === 'accept'" class="p-5 sm:p-7">
                ...
                '.'
                            ...
                            <div class="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-center">
                                ...
                                <button type="button" x-on:click="decision = null" class="
                                                                                                    rounded-lg
                                ...
                                <button type="button" wire:click="accept" wire:loading.attr="disabled" wire:target="accept"
                                    class="
                                                                                                    rounded-lg
                    ...
                    <div x-cloak x-show="decision === 'reject'" class="p-5 sm:p-7">
                        <div class="mx-auto max-w-xl">
                            ...
                            <div class="text-center">
                                ...
                                <p class="
                                                ...
                                                dark:text-zinc-400
                                            ">
                                    Se quiser, conte rapidamente o que pesou
                                    na sua decisão. Essa informação é opcional.
                                </p>
                            </div>
                                ...
                                <div class="
                                    ...
                                    @foreach ([
                                        ...
                                        : 'sm:col-span-2' }}
                                                                            ...
                                                                            dark:has-[:checked]:border-red-800
                                                                            dark:has-[:checked]:bg-red-950/40
                                                                            dark:has-[:checked]:text-red-300
                                                                        ">
                                                            <input type="radio" value="{{ $value }}" wire:model="rejectReason" class="sr-only">
                            ...
                            <div class="mt-5">
                                <label for="reject-comment" class="
                                                text-sm font-semibold
                                                text-zinc-800
                                                dark:text-zinc-200
                                            ">
                                ...
                                <textarea id="reject-comment" wire:model="rejectComment" rows="3" maxlength="500"
                                    placeholder="Ex.: preciso rever a proposta, o prazo ou o escopo antes de seguir." class="
                                                mt-2 w-full
                                                resize-none
                                                rounded-xl
