...
new #[Title('Editar orçamento | Fechou')] class extends Component
{
    ...
    */
    ...
    public function mount(int $quote): void
    {
        ...
        $this->quoteNumber = $quoteModel->number;

        $this->clientId = $quoteModel->client_id;
        $this->clientSearch = $quoteModel->client->name;

        $this->title = $quoteModel->title;
        $this->description = $quoteModel->description ?? '';

        $this->validUntil = $quoteModel->valid_until
            ? $quoteModel->valid_until->format('Y-m-d')
            : '';

        $this->discount = (string) (float) $quoteModel->discount;
        $this->notes = $quoteModel->notes ?? '';

        $this->items = $quoteModel
            ->items
            ->map(fn ($item) => [
                'type' => $item->type,
    ...
    */
    ...
    {
        /*
         * Se o usuário digitou um nome que não existe,
         * aproveitamos o texto digitado.
         *
         * Se já havia um cliente selecionado, abrimos
         * o cadastro com o nome em branco.
         */
        $this->newClientName = $this->clientId
            ? ''
    ...
    public function saveNewClient(): void
    {
        ...
        /*
         * Evita duplicidade por CPF/CNPJ.
         */
        ...
        /*
         * Seleciona automaticamente o cliente criado.
         */
        $this->clientId = $client->id;
        $this->clientSearch = $client->name;
    ...
    */
    ...
    public function save()
    {
        ...
        /*
         * Verificação novamente no momento de salvar.
         */
        abort_if(
            $quote->status !== 'draft',
            403,
        ...
        DB::transaction(function () use (
            ...
            /*
             * Como é rascunho, substituímos os itens.
             */
            $quote->items()->delete();
...
<div class="mx-auto max-w-7xl space-y-6">
    ...
    <div>
        ...
        <a
            href="{{ route('quotes.show', $quoteId) }}"
            wire:navigate
            class="
                                    ...
                                    >
                                        ...
                                        @forelse ($this->clientResults as $client)
                                            ...
                                            <button
                                                ...
                                                wire:key="edit-client-result-{{ $client->id }}"
                    ...
                    @else
                        ...
                        <div class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                                Escolha Serviço, Material ou Outro para adicionar.
                            </p>
            ...
            >
                ...
                <div class="space-y-4 px-6 py-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                            Facilita o envio da proposta pelo WhatsApp.
                        </p>
